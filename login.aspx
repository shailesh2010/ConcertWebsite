         ...
         <tr>
            ...
            <tr>
                <td >
                    UserID</td>
                <td >
                    <asp:TextBox ID="txtuserid" runat="server" Width="156px" 
                        style="margin-left: 0px" ></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="enter username " ControlToValidate="txtuserid"></asp:RequiredFieldValidator>
                </td>
            ...
            <td colspan="2" class="style3">
                <asp:HyperLink ID="HyperLink2" runat="server" ForeColor="#FF0066" 
                    NavigateUrl="~/bandlogin.aspx">band login or signup</asp:HyperLink>
            </td>
            </tr>
            <tr>
                <td class="style1" colspan="2">
                    <asp:HyperLink ID="HyperLink1" runat="server" ForeColor="#CC0000" 
                        NavigateUrl="~/signup.aspx">user sign up</asp:HyperLink>
                </td>
